...
Marketing- oder Hero-Optik ist erlaubt auf:

- externe Landingpage
- Login, Welcome und Onboarding
- PWA-Install-Hinweis
- App Icon und Splash
- Share Cards und Brand-Material
...
- Live-Coaching-Screens
- Check-in-Listen
- Training-Live-Flows
- Nachbereitungsqueue
- Spielerlisten und operativen Player Rows
...
- App-Icon darf markanter sein als die operative UI.
- Icon/Logo sollen Field-Operations, Praezision und Coach-Arbeit signalisieren, nicht Fan-Shop oder Fitness-App.
