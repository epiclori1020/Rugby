...
- Redesign-v2 ist gestartet: R1A Tokens v2 & Field-Mode Token-Fundament ist abgeschlossen. R1B Theme-Persistenz & Field-Mode Toggle ist abgeschlossen: Field Mode ist ueber Einstellungen steuerbar und persistiert `system/light/dark`, ohne R2/R5/R8/R9 vorzuziehen. `docs/superpowers/plans/2026-07-08-onfield-redesign-v2-heritage-field-instrument.md` bleibt die aktive Roadmap fuer Route A "Heritage Field Instrument".

## Naechste empfohlene Schritte

1. Redesign-v2 mit dem naechsten freigegebenen Slice fortsetzen: R2 Typo-/Weight-/Numeric-Refactor oder die geplanten P0-Sicherheits-/Redesign-Slices nach Roadmap; keine spaeteren Redesign-Sprints nebenbei umsetzen.
