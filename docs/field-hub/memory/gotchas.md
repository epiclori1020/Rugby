...
| active | Tages-Scores und Warnlisten driften, wenn sie aus getrennten Rohquellen aufgebaut werden. | Fuer `Squad heute` eine gemeinsame Domain-Ableitung nutzen: nur eingecheckte Spieler fuer Ampel/Returner/Aufmerksamkeit, pro Spieler eine aggregierte Zeile und `offen` niemals automatisch als Returner zaehlen. |
