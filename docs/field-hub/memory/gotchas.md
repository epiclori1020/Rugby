...
| active | Blinde Hook-/Memory-Automatik erzeugt falsches Vertrauen. | Sprint 0D-Runtime darf nur lokale ignored Captures, Daily Logs, Knowledge, Reports, Backups und Orphans verwalten. Current State, Decision Log, Roadmap und SSOTs bleiben manuelle Memory-Closeout-Entscheidungen des Agenten. |
