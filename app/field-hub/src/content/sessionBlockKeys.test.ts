...
const expectedBlockKeysBySession: Record<string, string[]> = {
  ...
  'kw28-di-2026-07-07': ['checkin-prep-speed', 'power-strength', 'robustness-tempo'],
  'kw28-do-2026-07-09': ['checkin-prep-speed', 'power-strength-pods', 'contact-microdose-conditioning'],
  'kw29-di-2026-07-14': ['checkin-prep-speed', 'power-strength', 'robustness-conditioning-review'],
  'kw29-do-2026-07-16': ['checkin-prep-speed', 'power-strength', 'cluster-robustness-tempo'],
  'kw30-di-2026-07-21': [
    'check-in-ramp',
    'track-speed-quality',
    'power-primer',
